...
public class ArticleDetailFragment extends Fragment implements
    ...
    public ArticleDetailActivity getActivityCast() {
        return (ArticleDetailActivity) getActivity();  //despite warning this works fine
    }
...
//https://stackoverflow.com/questions/32038332/using-google-design-library-how-to-hide-fab-button-on-scroll-down
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            String bodyTextShortened = bodyText.substring(0,1000); // Truncated to enhance performance as per forum mentor's suggestion:
                                                                   // https://discussions.udacity.com/t/articledetailfragment-doing-too-much-work-on-mainthread/655524
            bodyView.setText(Html.fromHtml(bodyTextShortened));
